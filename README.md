...
- logging to browser console log (flutter web)
...
- how to payload relays between websocket in flutter web and serial port in middleware
- how to payload publication/subscription between websocket module and serial module using localbus
...
- how to use static data and stream data in flutter web
...
- /web/index.html      # html page
- /web/index.js        # electron main
```

Electron Framework using NodeJS
```bash
...
```bash
- /web/middleware/server/api           # api service
- /web/middleware/server/api/index.js  # (api/ws module)
- /web/middleware/server/api/serial.js # api to serial port list
...
### Electron App (Default Frame Size)

By default, electron app beginning 1024 x 768 size.
...
If you want change to perfered language such as 'ko' is korean, You just disable this line.
...
- should better to open JavaScript Debug Terminal in vscode: ctrl+`, and check to + button in right side menu.
